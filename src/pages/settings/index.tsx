...
const profileURL = "/src/assets/rui-iconica-profile.jpeg";
...
export function Settings() {
  ...
  const handleUpdateGeneralData = () => {
    ...
    if (userUpdate.username === userLocalStorage.username)
      delete userUpdate.username;
    if (userUpdate.email === userLocalStorage.email) delete userUpdate.email;
    if (userUpdate.full_name === userLocalStorage.full_name)
      delete userUpdate.full_name;
  ...
  return (
    <div className="container-user row mt-3">
      ...
      <div className="form">
        <div className="form-update-general-data mb-5">
          <label htmlFor="formControlFullName" className="form-label">
            Nome
          </label>
          <input
            type="text"
          ...
          <label htmlFor="formControlUsername" className="form-label">
            Username
          </label>
          <input
            type="text"
        ...
        <div className="form-update-password mb-5">
          <label htmlFor="formControlOldPassword" className="form-label">
            Senha Antiga
          </label>
          <input
            type="password"
          ...
          <label htmlFor="formControlConfirmPassword" className="form-label">
